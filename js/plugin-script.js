...
function calculateCost() {
    ...
    if (jobType && squareMeters) {
        ...
        var laborCost = squareMeters * price;

        // Kontrollera om materialType är definierad i materialPrices
        if (materialPrices.hasOwnProperty(materialType)) {
            var laborFactor = materialPrices[materialType]['labor_factor'];
            laborCost *= laborFactor;
            ...
            if (jobType === "Målning-Fasad") {
                // Anpassning för Målning-Fasad
                var paintLiters = squareMeters / 7;
                var paintPricePerLiter = 300;
                var paintCost = paintLiters * paintPricePerLiter;
                totalCostWithoutRot += paintCost;
            }
            ...
            if (jobType === "Målning-Inomhus") {
                // Anpassning för Målning-Inomhus
            ...
            alert("Det valda materialet är inte definierat för den valda kategorin.");
        }
    } else {
